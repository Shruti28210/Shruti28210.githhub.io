                    ...
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          ...
                          <p>This is a clone of the website The-Bowl-Company where we implemented some additional features for better user experience</p>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          ...
                          <p>This is a clone of Dot and Key Skincare website, which is a new age skincare brand with products such as Serum, Moisturizer and skincare products.</p>
                        </div>
                      </div>
                      <div className="col-sm-4">
                        <div className="w-like">
                    ...
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          ...
                          <p>A clone of Koovs.com website which offers online store for western fashion, catering to menswear, womenswear, footwear, accessories, jewellery and beauty products.</p>
